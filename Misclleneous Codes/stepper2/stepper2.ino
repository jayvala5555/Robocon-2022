...
# define X_ENgnd  3 //ENA-(ENA) stepper motor enable , active low     Gray 
# define X_EN_5v  4 //ENA+(+5V) stepper motor enable , active low     Orange
# define X_DIRgnd 5 //DIR-(DIR) axis stepper motor direction control  Blue
# define X_DIR_5v 6 //DIR+(+5v) axis stepper motor direction control  Brown
# define X_STPgnd 7 //PUL-(PUL) axis stepper motor step control       Black
